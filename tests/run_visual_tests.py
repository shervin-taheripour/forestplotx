...
def build_cases() -> list[Case]:
    return [
        ...
        Case("F4", "footer text", "binom", dict(model_type="binom", exponentiate=False, footer_text="Adjusted for age and sex")),
        Case("F5", "block spacing tight", "linear", dict(model_type="linear", block_spacing=3.0)),
        Case("F6", "block spacing wide", "linear", dict(model_type="linear", block_spacing=10.0)),
        Case("F7", "bold override", "binom", dict(model_type="binom", exponentiate=False, bold_override={"predictor2": {"outcome1": True}})),
        # H
